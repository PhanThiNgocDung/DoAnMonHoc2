...
namespace QL_TourDLPM
{
    public class ExcelExport
    {
            ...
            string fullPathTemplateFileName, bool isPrintPreview, ref string outputFileName)
        {
            ...
            // Fill variables
            markProcessor.AddVariable("Sample", dataSource);
        ...
        public void BuildGameReportReplacer(ref Dictionary<string, string> replacer,  string tongThanhTien, string nguoiLapHD)
        {
            if (replacer != null)
            {
                
                replacer.Add("%TongThanhTien", tongThanhTien);
                replacer.Add("%TenNguoiLap", nguoiLapHD);
               
            }
        }
        public bool ThongKeGame(List<HoaDonExportInfor> dataSource, ref string fileName, bool isPrintPreview, string tongThanhTien, string nguoiLapHD)
        {
            // Check if data is null
            ...
            BuildGameReportReplacer(ref replacer,tongThanhTien, nguoiLapHD);
            return OutSimpleReport(dataSource, replacer, @"D:\UngDung\QL_TourDLPM\HoaDon.xls", isPrintPreview, ref fileName);
        }
    }
}
